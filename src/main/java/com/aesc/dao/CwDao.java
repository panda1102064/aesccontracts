...
public interface CwDao {
    ...
    /**
     * 
     * 方法名称: queryAll ； 方法描述: TODO: ； 返回类型: ArrayList<Cw> ； 创建人：Dawn Chen ；
    ...
    /**
     * 
     * 方法名称: save ； 方法描述: TODO: ； 返回类型: void ； 创建人：Dawn Chen ； 创建时间：2017年7月19日
     * 下午3:29:07； @throws
     */
    void save(Cw cw);
    ...
    /**
     * 
     * 方法名称: queryById ； 方法描述: TODO: ； 返回类型: Cw ； 创建人：Dawn Chen ；
