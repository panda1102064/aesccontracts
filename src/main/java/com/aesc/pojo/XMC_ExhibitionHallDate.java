 ...
 * File Name:XMC_ExhibitionHallDate.java  
 * Package Name:com.aesc.pojo  
 * Date:2018年12月19日上午10:41:56  
...
/**  
 * description：
 * ClassName:XMC_ExhibitionHallDate <br/>  
 * Function: TODO ADD FUNCTION. <br/>  
 * Reason:   TODO ADD REASON. <br/>  
 * Date:     2018年12月19日 上午10:41:56 <br/>  
 * @author   Dawn Chen  
 * @version    
 * @since    JDK 1.8  
 * @see        
 */
public class XMC_ExhibitionHallDate {
  ...
  public String toString() {
    return "EscDate [date_id=" + date_id + ", year_str=" + year_str + ", month_str=" + month_str
        ...
        + day_ed + ", price=" + price + ", total=" + total + ", upper=" + upper + ", contract_id=" + contract_id + "]";
  }
}
