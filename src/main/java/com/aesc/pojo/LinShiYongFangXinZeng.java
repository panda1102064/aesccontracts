 ...
 * File Name:LinShiYongFangXinZeng.java  
 * Package Name:com.aesc.pojo  
 * Date:2018年10月23日下午2:12:08  
...
/**  
 * description：
 * ClassName:LinShiYongFangXinZeng <br/>  
 * Function: TODO ADD FUNCTION. <br/>  
 * Reason:   TODO ADD REASON. <br/>  
 * Date:     2018年10月23日 下午2:12:08 <br/>  
 * @author   Dawn Chen  
 * @version    
 * @since    JDK 1.8  
 * @see        
 */
public class LinShiYongFangXinZeng {
  ...
  public String toString() {
      return "Entity{" +
              ...
              ", upper1='" + upper1 + '\'' +
              ", area4='" + area4 + '\'' +
              ", management_fee1='" + management_fee1 + '\'' +
              ", management_fee2='" + management_fee2 + '\'' +
              ...
              ", payment4='" + payment4 + '\'' +
              ", payment5='" + payment5 + '\'' +
              ", charge_year2='" + charge_year2 + '\'' +
              ", charge_month2='" + charge_month2 + '\'' +
              ", charge_day2='" + charge_day2 + '\'' +
              ", purpose='" + purpose + '\'' +
              ", remark='" + remark + '\'' +
              ...
              ", confirmation_signatory='" + confirmation_signatory + '\'' +
              ", confirmation_year='" + confirmation_year + '\'' +
              ", confirmation_month='" + confirmation_month + '\'' +
