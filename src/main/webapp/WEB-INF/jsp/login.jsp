	            ...
	            <div id="wrapper">
	                <div id="login" class="animate form">
	                    <form  action="login" method="post"> 
							...
							<center style="font-style: oblique;color: red;">${msg}</center>
...
<script src="http://open.sojson.com/common/js/canvas-nest.min.js" count="300" zindex="-2" opacity="0.5" color="0,0,0" type="text/javascript"> 
</script> 
</body>
</html>