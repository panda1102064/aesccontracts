...
<jsp:include page="../../headpart.jsp"></jsp:include>
		...
		<form action="saveXescscldtcw" method="post">
			...
			<p>&nbsp;&nbsp;一、甲方向乙方提供<input required="required" class="dtkz"  name="place" value="新二手车市场楼顶停车场整层" /> ，该停车场仅用于<input required="required" class="dtkz"  name="popours" />停放。</p>
			<p>&nbsp;&nbsp;二、租赁期：<input required="required" name="year_start" class="dtkzNum" type="text" value="2018" />年<input required="required" class="dtkzNum" type="text" name="month_start" value="1" />月 <input required="required" class="dtkzNum" type="text" name="day_start" value="1" />日至 <input required="required" class="dtkzNum" type="text" name="year_end" value="2018" />年<input required="required" class="dtkzNum" type="text" name="month_end" value="12" />月 <input required="required" class="dtkzNum" type="text" name="day_end" value="31" />日止。场地租金单价（按乙方实际承租面积计收）为：<input required="required" class="dtkzNum"  name="price" />元/月/㎡，每月租金合计人民币：<input required="required" class="dtkzNum"  name="rent" />元（大写：<input required="required" class="dtkz"  name="upper1" />元整  ）。</p>
			<p>&nbsp;&nbsp;三 、本合同签订后乙方应向甲方一次性支付履约保证金：￥<input required="required" class="dtkzNum"  name="cash_deposit" />元（大写：<input required="required" class="dtkz"  name="upper2" />整 ）。</p>
			...
			<p>&nbsp;&nbsp;四、房屋租金按<input required="required" class="dtkz"  name="payment1" />支付。乙方应自本合同签订当日向甲方支付第一个<input required="required" class="dtkz"  name="payment2" />的租金，以后乙方应在每<input required="required" class="dtkz"  name="payment3" />初第一个月第<input required="required" class="dtkz"  name="payday" />日前支付本<input required="required" class="dtkz"  name="payment4" />的租金。乙方每逾期一日，甲方有权按照应交款总额的 0.5% 收取乙方的滞纳金，逾期超过15日，甲方有权单方面解除合同，并向乙方追缴所欠租金和滞纳金。（乙方应向甲方提供开具专票的相关证明和信息，如果乙方纳税政策有调整，需提前【30】日通知甲方，并出具相关调整说明。）</p>
