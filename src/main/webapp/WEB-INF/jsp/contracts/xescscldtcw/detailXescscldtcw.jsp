...
<head>
	...
	<body>
		<div id="wrap">
			...
			<p>&nbsp;&nbsp;四、房屋租金按<u> ${aesc.payment1} </u>支付。乙方应自本合同签订当日向甲方支付第一个<u> ${aesc.payment2} </u>的租金，以后乙方应在每<u> ${aesc.payment3} </u>初第一个月第<u> ${aesc.payday} </u>日前支付本<u> ${aesc.payment4} </u>的租金。乙方每逾期一日，甲方有权按照应交款总额的 0.5% 收取乙方的滞纳金，逾期超过15日，甲方有权单方面解除合同，并向乙方追缴所欠租金和滞纳金。（乙方应向甲方提供开具专票的相关证明和信息，如果乙方纳税政策有调整，需提前【30】日通知甲方，并出具相关调整说明。）</p>
