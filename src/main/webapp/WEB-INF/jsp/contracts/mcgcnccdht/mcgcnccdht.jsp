...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveMcgcnccdht" method="post">
				...
				<p>&nbsp;&nbsp;9.3、商业用户水电交费单价分别为：电<input required="required" class="dtkzNum" name="power_rate" value="1.14" readonly="readonly" />元人民币/KW/小时，水<input required="required" readonly="readonly" class="dtkzNum" name="water_rate" value="4.80"/>元人民币/T（含公共区域分摊费）。</p>
