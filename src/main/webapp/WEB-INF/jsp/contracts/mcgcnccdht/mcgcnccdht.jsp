...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveMcgcnccdht" method="post">
				...
				<p>&nbsp;&nbsp;1、乙方作为入驻汽博中心<input required="required" class="dtkz" name="area1" value="名车广场" />的承租人，承诺自觉遵守物业管理区域的各项使用管理规定，维护汽博中心<input required="required" class="dtkz" name="area2" value="名车广场" />的整体品牌形象及商业信誉。</p>
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<input required="required" class="dtkz" name="rental_location" value="名车广场" />的承租人，承诺自愿接受甲方于<input required="required" class="dtkzNum" name="accept_year" value="" />年<input required="required" class="dtkzNum" name="accept_month" value="1" /> 月 <input required="required" class="dtkzNum" name="accept_day" value="1" /> 日与重庆博展物业管理有限公司（以下简称“物业公司”）签订的《物业管理委托服务合同》之内容的约束，并按照该合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业， 则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。 </p>
				<p class="zc">第二章 租赁物业概况</p>
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆北部新区经开园金渝大道99号（以下简称“汽博中心”）内的<input required="required" class="dtkz" name="lessee_location" value="名车广场"/>，其建筑面积为：<input required="required" class="dtkzNum" name="building_area" value="㎡ "/>，该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				<p>&nbsp;&nbsp;3.2、租赁物业的前上述信息与《房屋产权登记证》所载明的信息不一致时，以《房屋产权登记证》为准。</p>
				<p class="zc">第三章 租赁期限及租赁物业交付</p>
				<p>&nbsp;&nbsp;4、本合同项下商业用房（场地）租赁期限为<input required="required" class="dtkzNum" name="expires" value="\" />年，即从自<input required="required" class="dtkzNum" name="year_start" value="" />年<input required="required" class="dtkzNum" name="month_start" value="1" />月<input required="required" class="dtkzNum" name="day_start" value="1" />日起至<input required="required" class="dtkzNum" name="year_end" value="" />年<input required="required" class="dtkzNum" name="month_end" value="6" />月<input required="required" class="dtkzNum" name="day_end" value="30" />日止。</p>
				<p>&nbsp;&nbsp;5、甲方于<input required="required" class="dtkzNum" name="transfer_year" value="" />年<input required="required" class="dtkzNum" name="transfer_month" value="1" />月<input required="required" class="dtkzNum" name="transfer_day" value="1" />日前将本合同项下的商业用房（场地）移交给乙方使用。</p>
				...
				<p>&nbsp;&nbsp;7.2、房屋租金按<input required="required" class="dtkz" name="payment1" value="季度"/>支付。乙方应自本合同签订当日向甲方支付第一个<input required="required" class="dtkz" name="payment2" value="季度"/>的租金，以后乙方应在每<input required="required" class="dtkz" name="payment3" value="季度"/>初第一个月第15日前支付本<input required="required" class="dtkz" name="payment4" value="季度"/>的租金。乙方逾期交纳租金，逾期在15内的，每逾期一日，应按未交纳租金的总额0.5％的标准向甲方支付滞纳金；逾期时间超过10日的，甲方有权单方解除合同，不予退还履约保证金，并可向乙方追收所欠租金及滞纳金。</p>
				<p>&nbsp;&nbsp;7.3、前述租金的付款方式：现金或转帐。</p>
				<p>&nbsp;&nbsp;7.4、上述收费起算时间：从<input required="required" class="dtkzNum" name="charge_year1" value="" />年<input required="required" class="dtkzNum" name="charge_month1" value="1" />月<input required="required" class="dtkzNum" name="charge_day1" value="1" />日起算。</p>
				...
				<p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<input required="required" class="dtkz" name="area3" value="名车广场" />的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<input required="required" class="dtkzNum" name="management_fee1" value="4"/>元/㎡/月，物业管理服务费：<input required="required" class="dtkzNum" name="management_fee2" />元/月。</p>
				<p>&nbsp;&nbsp;9.2、中央空调使用耗能费：按实际公示标准收费。</p>
				<p>&nbsp;&nbsp;9.3、商业用户水电交费单价分别为：电<input required="required" class="dtkzNum" name="power_rate" value="1.14" />元人民币/KW/小时，水<input required="required" class="dtkzNum" name="water_rate" value="4.80"/>元人民币/T（含公共区域分摊费）。</p>
				<p>&nbsp;&nbsp;9.4、公共区域的水电等公摊费用按据实分摊的原则收取。</p>
				<p>&nbsp;&nbsp;9.5、前述物业费用按<input required="required" class="dtkz" name="payment5" value="季度" />支付：在签定合同时，乙方应向物业公司支付第一个<input required="required" class="dtkz" name="payment6" value="季度" />的物业费，以后乙方应在每<input required="required" class="dtkz" name="payment7" value="季度" />初15日前向物业公司支付下个<input required="required" class="dtkz" name="payment8" value="季度" />的物业费。 </p>
				...
				<p>&nbsp;&nbsp;10.1、上述收费起算时间：从<input required="required" class="dtkzNum" name="charge_year2" value="" />年<input required="required" class="dtkzNum" name="charge_month2" value="1" />月<input required="required" class="dtkzNum" name="charge_day2" value="1" />日起算。</p>
				<p class="zc">第五章 营业资格及乙方经营范围</p>
				<p>&nbsp;&nbsp;11、乙方应具备在中华人民共和国境内依法取得经营主体资格并符合在汽博中心开业的条件。</p>
				<p>&nbsp;&nbsp;12、乙方租用甲方的房屋（场地）仅作为<input required="required" class="dtkz" name="purpose" />使用。乙方不得超出约定范围经营；如需变更经营范围，须提前二十天以书面形式告知甲方，经甲方书面同意后方可变更。否则，甲方有权单方解除合同，且不退还乙方已缴纳的租金及履约保证金。</p>
