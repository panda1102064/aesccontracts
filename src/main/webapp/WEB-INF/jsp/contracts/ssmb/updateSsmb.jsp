...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
        <div id="wrap">
            <form action="updateSsmb" method="post">
                ...
                <p>&nbsp;&nbsp;7.1、房屋（场地）租金（按乙方实际承租的建筑面积计收）为：每月租金合计人民币：<input required="required" class="dtkzNum" name="total" value="${aesc.total}" />元(大写)<input required="required" class="dtkz" name="upper1" value="${aesc.upper1}" />元整 。</p>
                ...
                <p>&nbsp;&nbsp;7.3、上述收费起算时间：从<input required="required" class="dtkzNum" name="charge_year1" value="${aesc.charge_year1}" />年<input required="required" class="dtkzNum" name="charge_month1" value="${aesc.charge_month1}" />月<input required="required" class="dtkzNum" name="charge_day1" value="${aesc.charge_day1}" />日起开始计租。</p>
