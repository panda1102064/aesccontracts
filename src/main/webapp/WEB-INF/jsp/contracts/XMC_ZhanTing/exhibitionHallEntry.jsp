...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveExhibitionHall" method="post">
				...
				<p>承租方[以下简称乙方]:<input class="form-control dtkzNum" name="merchant_name" /></p>
				<p>地址：<input  class="form-control dtkzNum" name="address" /></p><br />
				...
				<p>&nbsp;&nbsp;1、乙方作为入驻汽博中心<input required="required" class="dtkz" name="area1" value="新名车广场" />的承租人，承诺自觉遵守物业管理区域的各项使用管理规定，维护汽博中心<input required="required" class="dtkz" name="area2" value="新名车广场" />的整体品牌形象及商业信誉。</p>
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<input required="required" class="dtkz" name="rental_location" value="新名车广场" />的承租人，承诺自愿接受由甲方委托的重庆博展物业管理有限公司（以下简称“物业公司”）担任在汽博中心的物业服务企业，并按照本合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业，则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。</p>
				<p class="zc">第二章 租赁物业概况</p>
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆两江新区金渝大道99号附15号（以下简称“汽博中心”）内的<input required="required" class="form-control dtkz" name="lessee_location" value="新名车广场 楼展厅" />，其建筑面积为：<input required="required" class="dtkzNum" name="building_area" /> ㎡ 。该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				...
				<p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<input required="required" class="dtkz" name="area3" value="新名车广场" />的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<input required="required" class="dtkzNum" name="management_fee1" value="7"/>元/㎡/月，物业管理服务费：<input required="required" class="dtkzNum" name="management_fee2" />元/月。</p>
				...
				<p>&nbsp;&nbsp;9.5、前述物业费用按<input required="required" class="dtkz" name="payment5" value="季度" />支付；在签定合同时，乙方应向物业公司支付<input required="required" class="dtkz" name="payment6" value="第一个季度" />的物业费，以后乙方应在<input required="required" class="form-control dtkz" name="payment7" value="在每季度初25日前支付下个季度"/>的物业费。 </p>
				...
				<p>&nbsp;&nbsp;12、乙方租用甲方的房屋（场地）仅作为<input required="required" class="dtkz" name="purpose"/>展示使用。乙方租用的上述房屋（场地）仅供自己使用，未经甲方书面同意，不得转租、转让、许可第三方使用或擅自更改场地用途。乙方不得随意更改店招、门头。乙方不得利用展厅内部空间随意搭建或夹层。乙方不得超出约定范围经营；如需变更以上提及事项，须提前三十天以书面形式告知甲方，经甲方书面同意后方可变更。否则，甲方有权单方解除合同，且不退还乙方已缴纳的租金及履约保证金。</p>
				...
				<p>&nbsp;&nbsp;13.2、若乙方违反本条上述约定，甲方有权解除本合同，同时合同解除后除乙方立即搬出经营场地之外，已交纳的租金及履约保证金不予退还。</p>
