...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
		<div id="wrap">
			<form action="updateExhibitionHall" method="post">
				...
				<div id="main">
					<ol>
						<c:forEach items="${requestScope.exhibitionHallDateList}" var="exhibitionHallDateList">
							<li><p><input type="hidden" name="date_id" value="${exhibitionHallDateList.date_id}" /><input required="required" class="dtkzNum" name="year_str" value="${exhibitionHallDateList.year_str}" />年<input required="required" class="dtkzNum" name="month_str" value="${exhibitionHallDateList.month_str}" />月<input required="required" class="dtkzNum" name="day_str" value="${exhibitionHallDateList.day_str}" />日至<input required="required" class="dtkzNum" name="year_ed" value="${exhibitionHallDateList.year_ed}" />年<input required="required" class="dtkzNum" name="month_ed" value="${exhibitionHallDateList.month_ed}" />月<input required="required" class="dtkzNum" name="day_ed" value="${exhibitionHallDateList.day_ed}" />日，租金单价为：<input required="required" class="dtkzNum" name="price" value="${exhibitionHallDateList.price}" />元/㎡/月，每月租金合计为：<input required="required" class="dtkzNum" name="total" value="${exhibitionHallDateList.total}" />元；大写：<input required="required" class="dtkzNum" name="upper" value="${exhibitionHallDateList.upper}" />元整。</p><!-- <input class="btn-danger" type="button" value="添加" id="bt" /> --></li>
						</c:forEach>
					</ol>
				</div>
