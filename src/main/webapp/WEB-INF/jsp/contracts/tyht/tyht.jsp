...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveTyht" method="post">
				...
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：<p><textarea rows="5" cols="100%" name="lessee_location" class="form-control" required="required" />重庆市北部新区经开园金渝大道99号（以下简称“汽博中心”）内的</textarea></p>，<input required="required" class="dtkzNum" name="building_area" value="其建筑面积为：㎡" /> ，该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				...
				<p>&nbsp;&nbsp;7.1、房屋（场地）租金（按乙方实际承租的建筑面积计收）为：<input required="required" class="dtkzNum" name="rent1" value="元/月/㎡"/>，每月租金合计人民币：<input required="required" class="dtkzNum" name="total" />元(大写)<input required="required" class="dtkz" name="upper1" />元整 。</p>
