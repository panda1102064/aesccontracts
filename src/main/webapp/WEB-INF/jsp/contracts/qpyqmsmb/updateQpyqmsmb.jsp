...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
		<div id="wrap">
			<form action="updateQpyqmsmb" method="post">
				...
				<p>&nbsp;&nbsp;10.1、上述收费起算时间：从<input required="required" class="dtkzNum" name="charge_year2" value="2018" value="${aesc.purpose}" />年<input required="required" class="dtkzNum" name="charge_month2" value="${aesc.charge_month2}" />月<input required="required" class="dtkzNum" name="charge_day2" value="${aesc.charge_day2}" />日起开始计租。</p>
				...
				<p>&nbsp;&nbsp;43、备注：<input class="dtkz" name="remark" /></p>
