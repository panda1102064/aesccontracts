...
<body>
		...
		<div class="PageNext"><jsp:include page="../../cover.jsp"/><!--动态包含--></div>
				...
				<p>&nbsp;&nbsp;7.2、房屋租金按<u> ${aesc.payment1} </u>支付。乙方应自本合同签订当日向甲方支付第一个<u> ${aesc.payment2} </u>的租金，以后乙方应在每<u> ${aesc.payment3} </u>初第一个月第15日前支付<u> ${aesc.payment4} </u>的租金。乙方逾期交纳租金，逾期在15内的，每逾期一日，应按未交纳租金的总额0.5％的标准向甲方支付滞纳金；逾期时间超过15日的，甲方有权单方解除合同，不予退还履约保证金，并可向乙方追收所欠租金及滞纳金。</p>
