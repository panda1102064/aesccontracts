...
<body>
	...
	<div id="wrap">
            <form action="saveMcgctcc" method="post">
                ...
                <p>第三条&nbsp;本合同所涉商业用房（场地）租赁期限为<input required="required" class="dtkzNum" name="expires" value="/" />年，从<input required="required" class="dtkzNum" name="year_start" value="" />年<input required="required" class="dtkzNum" name="month_start" value="1" />月<input required="required" class="dtkzNum" name="day_start" value="1" />日起至<input required="required" class="dtkzNum" name="year_end" value="" />年<input required="required" class="dtkzNum" name="month_end" value="6" />月<input required="required" class="dtkzNum" name="day_end" value="30" />日止。</p>
                ...
                <p>&nbsp;&nbsp;4、付款方式：现金或转帐支票。</p>
                <p>第二十八条&nbsp;上述收费起算时间：双方约定起租时间从<input required="required" class="dtkzNum" name="lease_year" value="" />年<input required="required" class="dtkzNum" name="lease_month"  value="1"/>月<input required="required" class="dtkzNum" name="lease_day" value="1" />日起算。</p>
