...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveQpeqmsmb" method="post">
				...
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：<input required="required" class="dtkz" name="lessee_location" value="重庆北部新区经开园金渝大道99号（以下简称“汽博中心”）内的汽配二期" />，其建筑面积为：<input required="required" class="dtkzNum" name="building_area" />㎡ ，该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
