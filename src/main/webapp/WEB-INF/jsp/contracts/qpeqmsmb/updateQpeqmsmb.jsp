...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
		<div id="wrap">
			<form action="updateQpeqmsmb" method="post">
				...
				<p>&nbsp;&nbsp;7.1、房屋（场地）租金（按乙方实际承租的建筑面积计收）为一楼：<input required="required" class="dtkzNum" name="rent1" value="${aesc.rent1}" />，每月租金合计人民币：<input required="required" class="dtkzNum" name="total" value="${aesc.total}" />元(大写)<input required="required" class="dtkz" name="upper1" value="${aesc.upper1}" />元整 。</p>
				...
				<p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<input required="required" class="dtkz" name="area3" value="${aesc.area3}" />的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为<input required="required" class="dtkz" name="management_fee1" value="${aesc.management_fee1}" />，物业管理服务费：<input required="required" class="dtkzNum" name="management_fee" value="${aesc.management_fee}" />元/月。</p>
				...
				<p>&nbsp;&nbsp;43、备注：<input class="dtkz" name="remark" value="${aesc.remark}" /></p>
			...
			<p class="butn">
				...
				<input type="hidden" name="status" value="${aesc.status}" />
