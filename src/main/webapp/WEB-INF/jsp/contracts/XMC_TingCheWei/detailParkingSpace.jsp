...
<head>
	...
	<body>
		<div id="wrap">
			...
			<p>&nbsp;&nbsp;四、乙方须按 <u> ${aesc.payment_way} </u>向甲方交付车辆停放场地使用服务费，甲方应提供相关正规发票，交款时间为<u> ${aesc.payment_time} </u>的服务费。乙方每逾期一日，甲方有权将按照应交款总额的0.5%收取乙方的滞纳金。逾期时间超过15日的，甲方有权单方解除合同，不予退还履约保证金，并可向乙方追收所欠租金及滞纳金。同时，甲方有权不让乙方车辆进出新名车广场地下停车库，直到乙方所欠费用结清。</p>
