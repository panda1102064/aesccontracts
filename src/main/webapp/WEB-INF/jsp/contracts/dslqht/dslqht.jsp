...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveDslqht" method="post">
				...
				<p>&nbsp;&nbsp;1、乙方作为入驻汽博中心<input required="required" class="dtkz" name="area1" value="汽博大厦" />的承租人，承诺自觉遵守物业管理区域的各项使用管理规定，维护汽博中心<input required="required" class="dtkz" name="area2" value="汽博大厦" />的整体品牌形象及商业信誉。</p>
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<input class="dtkz" name="rental_location" required="required" value="汽博大厦" />的承租人，承诺自愿接受甲方于<input required="required" class="dtkzNum" name="accept_year" id="accept_year"/>年<input required="required" class="dtkzNum" name="accept_month" value="1"/> 月 <input required="required" class="dtkzNum" name="accept_day" value="1" /> 日与重庆博展物业管理有限公司（以下简称“物业公司”）签订的《物业管理委托服务合同》之内容的约束，并按照该合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业， 则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。 </p>
				<p class="zc">第二章 租赁物业概况</p>
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆北部新区经开园金渝大道99号（以下简称“汽博中心”）内的<input required="required" class="dtkz" name="lessee_location" value="汽博大厦" />，其建筑面积为：<input required="required" class="dtkzNum" name="building_area" />㎡ ，该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				<p>&nbsp;&nbsp;3.2、租赁物业的前上述信息与《房屋产权登记证》所载明的信息不一致时，以《房屋产权登记证》为准。</p>
				<p class="zc">第三章 租赁期限及租赁物业交付</p>
				<p>&nbsp;&nbsp;4、本合同项下商业用房（场地）租赁期限为<input required="required" class="dtkzNum" name="expires" value="贰" />年，即从自<input required="required" class="dtkzNum" name="year_start" id="year_start" />年<input required="required" class="dtkzNum" name="month_start" value="1" />月<input required="required" class="dtkzNum" name="day_start" value="1" />日起至<input required="required" class="dtkzNum" name="year_end" id="year_end" />年<input required="required" class="dtkzNum" name="month_end" value="12" />月<input required="required" class="dtkzNum" name="day_end" value="31" />日止。</p>
				...
				<p>&nbsp;&nbsp;8、乙方应向甲方支付履约保证金：￥<input required="required" class="dtkzNum" name="cash_deposit" />元(大写)<input required="required" class="dtkz" name="upper2" />元整，在本合同签订时乙方应当立即以一次性付清的方式向甲方支付。合同有效期内若乙方擅自解除合同或有其它违反合同约定行为的，履约保证金和所剩租金不予退还，并纳入违约金范围之内。违约金不足以弥补损失的，另行赔偿。合同到期后，如乙方无违约行为，履约保证金如数退还，但不计算利息。</p>
				<p>&nbsp;&nbsp;8.1、前述保证金的付款方式：现金或转帐。</p>
				<p>&nbsp;&nbsp;9、乙方应当向物业公司缴纳的物业费用：</p>
				<p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<input required="required" class="dtkz" name="area3" value="汽博大厦" />的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<input required="required" class="dtkzNum" name="management_fee1" />元/㎡/月，物业管理服务费：<input required="required" class="dtkzNum" name="management_fee2" />元/月。</p>
				...
				<p>&nbsp;&nbsp;9.5、前述物业费用按<input required="required" class="dtkz" name="payment5" value="季度"/>支付：在签定合同时，乙方应向物业公司支付<input required="required" class="dtkz" name="payment6" value="季度"/>的物业费，以后乙方应在每<input required="required" class="dtkz" name="payment7" value="季度"/>初15日前向物业公司支付<input required="required" class="dtkz" name="payment8" value="季度"/>的物业费。 </p>
				<p>&nbsp;&nbsp;9.6、乙方如逾期10天不缴纳物业管理服务费或相关物业费用的，本合同约定物业公司有权按乙方应交付费用总额的每日3‰加收滞纳金；逾期20天者系恶意拖欠的，物业公司除有权按照5‰加收滞纳金还有权停止向乙方提供服务，同时视为乙方对本合同的根本性违约。</p>
				...
				<p>&nbsp;&nbsp;12、乙方租用甲方的房屋（场地）仅作为<input required="required" class="dtkz" name="purpose" />展示使用。乙方不得超出约定范围经营；如需变更经营范围，须提前二十天以书面形式告知甲方，经甲方书面同意后方可变更。否则，甲方有权单方解除合同，且不退还乙方已缴纳的租金及履约保证金。</p>
                ...
                <p>&nbsp;&nbsp;35、乙方在合同期限届满或因故提前终止时，乙方应在撤离该场地前，须将该租赁房屋（场地）恢复到甲方交付该租赁房屋（场地）的时原貌，如果乙方不能及时的恢复该租赁房屋（场地）时，甲方有权不予退还乙方的履约保证金和所剩租金，维修费不足以弥补损失的，另行赔偿。同时，甲方有权直接进入租赁物处理租赁物内乙方物品，由此给乙方造成损失（若有），甲方不承担任何责任。</p>
                <p>&nbsp;&nbsp;36、乙方承诺，放弃对租赁房屋的优先购买权，若甲方在租赁期内对外转让房屋的，无须向乙方作出通知。</p>
