...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
		<div id="wrap">
			<form action="updateTongYongHeTongKuaNian" method="post">
				...
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<input required="required" class="dtkz" name="rental_location" value="${aesc.rental_location}" />的承租人，承诺自愿接受由甲方委托的重庆博展物业管理有限公司（以下简称“物业公司”）担任在汽博中心的物业服务企业，并按照本合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业，则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。</p>
				<p class="zc">第二章 租赁物业概况</p>
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆北部新区经开园金渝大道99号（以下简称“汽博中心”）内的<input required="required" class="dtkz" name="lessee_location" value="${aesc.lessee_location}" />，<input required="required" class="dtkzNum" name="building_area" value="${aesc.building_area}" /> ，该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				...
				<div id="main">
					<ol>
						<c:forEach items="${requestScope.tongYongHeTongKuaNianList}" var="tongYongHeTongKuaNianList">
							<li><p><input type="hidden" name="date_id" value="${tongYongHeTongKuaNianList.date_id}" /><input required="required" class="dtkzNum" name="year_str" value="${tongYongHeTongKuaNianList.year_str}" />年<input required="required" class="dtkzNum" name="month_str" value="${tongYongHeTongKuaNianList.month_str}" />月<input required="required" class="dtkzNum" name="day_str" value="${tongYongHeTongKuaNianList.day_str}" />日至<input required="required" class="dtkzNum" name="year_ed" value="${tongYongHeTongKuaNianList.year_ed}" />年<input required="required" class="dtkzNum" name="month_ed" value="${tongYongHeTongKuaNianList.month_ed}" />月<input required="required" class="dtkzNum" name="day_ed" value="${tongYongHeTongKuaNianList.day_ed}" />日，租金单价为：<input required="required" class="dtkzNum" name="rent" value="${tongYongHeTongKuaNianList.rent}" />，每月租金合计为：<input required="required" class="dtkzNum" name="price" value="${tongYongHeTongKuaNianList.price}" />元，大写：<input required="required" class="dtkz" name="upper" value="${tongYongHeTongKuaNianList.upper}" /></p><!-- <input class="btn-danger" type="button" value="添加" id="bt" /> --></li>
						</c:forEach>	
					</ol>
				</div>
