...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
		<div id="wrap">
			<form action="updateEsc" method="post">
				...
				<p>&nbsp;&nbsp;9.2、商业用户水电交费单价分别为：电<input required="required" class="dtkzNum" name="power_rate" value="${aesc.power_rate}" />元人民币/KW/小时，水<input required="required" class="dtkzNum" name="water_rate" value="${aesc.water_rate}" />元人民币/T（含公共区域分摊费），网络服务费为<input required="required" class="dtkzNum" name="net_fee" value="${aesc.net_fee}" />元/㎡/月。</p>
