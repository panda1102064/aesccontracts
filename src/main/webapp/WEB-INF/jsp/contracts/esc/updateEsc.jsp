...
<%-- <jsp:include page="../../headpart.jsp"></jsp:include> --%>
		<div id="wrap">
			<form action="updateEsc" method="post">
				...
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<input required="required" class="dtkz" name="rental_location" value="${aesc.rental_location}" />的承租人，承诺自愿接受由甲方委托的重庆博展物业管理有限公司（以下简称“物业公司”）担任在汽博中心的物业服务企业，并按照该合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业， 则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。 </p>
				<p class="zc">第二章 租赁物业概况</p>
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆两江新区金渝大道99号附15号（以下简称“汽博中心”）内的<input required="required" class="dtkz" name="lessee_location" value="${aesc.lessee_location}" />，其建筑面积为：<input required="required" class="dtkzNum" name="building_area" value="${aesc.building_area}" /> ㎡ 。该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				...
				<p>&nbsp;&nbsp;10、前述物业费用付款方式：现金或转账。现金：乙方现金需缴纳至甲方财务部并开具发票式收据，甲方任何非财务人员不能现金收款；转账：乙方向甲方指定账户转账，非指定账户的转款不作为收款依据，乙方转账账户为乙方合同约定单位及公账，非合同约定单位或个人转账，需出具垫资证明。</p>
				...
				<p>&nbsp;&nbsp;33、乙方在合同期限届满或因故提前终止时，乙方应在撤离该场地前，须将该租赁房屋（场地）恢复到甲方交付该租赁房屋（场地）的时原貌，或保持为乙方向甲方申请的装修原装，如果乙方不能及时的恢复该租赁房屋（场地）时，甲方有权不予退还乙方的履约保证金和所剩租金，维修费不足以弥补损失的，另行赔偿。</p>
				<p>&nbsp;&nbsp;34、乙方在合同期限届满或因故提前终止时，乙方应及时向甲方办理交接手续，每逾期一日办理交接手续，乙方应按当月月租金的5％的金额向甲方支付滞纳金。逾期时间不得超过3日，否则甲方有权不予退还履约保证金，并可向乙方追收所欠租金及滞纳金。若乙方未按照前述约定向甲方交还租赁房屋（场地）的，甲方有权自行接管及进入租赁房屋（场地），乙方遗留在租赁房屋（场地）物品、设施，甲方亦有权自行处置，不对乙方承担任何赔偿责任，乙方对此无异议。</p>
				<p class="zc">第九章 合同的终止与解除</p>
				<p>&nbsp;&nbsp;35、合同履行过程中出现下列情形之一者，合同即告终止；</p>
				<p>&nbsp;&nbsp;(1).合同期满；</p>
				<p>&nbsp;&nbsp;(2).发生不可抗力（如地震、战争、自然灾害、政府变化政策等），致使协议无法继续履行。</p>
				<p>&nbsp;&nbsp;36、下列情形之一者，甲方有权解除合同，并要求乙方赔偿损失。</p>
				...
				<p>&nbsp;&nbsp;37、在合同期内，乙方因自身原因需提前解除合同，须提前三十日以书面形式向甲方提出，经甲方书面同意方可办理解除租赁手续，乙方所缴纳的剩余租金和履约保证金将作为违约金支付给甲方。未经甲方书面同意，乙方单方解除行为无效。</p>
				<p>&nbsp;&nbsp;38、因不可抗力因素导致合同无法履行，由双方各自承担所造成损失，互不追究对方承担损失的责任。</p>
				<p>&nbsp;&nbsp;39、合同期限届满或因故提前终止，乙方对租赁场地进行的装修无偿向甲方移交，不得故意损坏，对此甲方无需向乙方支付任何补偿。</p>
				<p>&nbsp;&nbsp;40、合同期限届满，乙方若需继续承租，应提前一个月向甲方提出书面申请。如甲方同意续租，双方应另行签订租赁合同。</p>
				<p class="zc">第十章 其 他</p>
				<p>&nbsp;&nbsp;41、本合同履行过程中若发生争议，双方应友好协商解决。协商解决不能的任何一方均有权申请重庆仲裁委员会根据其的仲裁规则进行仲裁。</p>
				<p>&nbsp;&nbsp;42、附则</p>
                <p>&nbsp;&nbsp;42.1、本合同未尽事宜，甲、乙双方可另行签订书面补充协议，其补充内容与本合同具有同等法律效力。</p>
                <p>&nbsp;&nbsp;42.2、合同签定地点：重庆汽博中心。</p>
                <p>&nbsp;&nbsp;42.3、本协议一式<u> 肆  </u>份，经甲、乙双方签署后生效，甲方执 <u> 叁 </u>份,乙方执<u> 壹 </u>份，各份具有同等法律效力。</p>
                <p>&nbsp;&nbsp;43、本合同有效附件有：（本合同附件系本合同当然组成部分，与本合同具有同等法律效力）</p>
                <p>&nbsp;&nbsp;附件1.消防安全责任确认书。</p>
                <p>&nbsp;&nbsp;44、乙方确认本合同及其附件的送达及在履行合同过程中接收甲方书面文件、司法诉讼过程中进行司法文书送达等均按以下所示准确地址发出；如乙方未填写本项地址，视为同意甲方直接可向乙方签约时营业执照地址、身份证地址进行寄送。</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;指定送达地址：<u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;邮编：<u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </u></p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;收件人：<u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </u> </p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;其他指定代收人：<u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </u>  </p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;电话：<u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u> </p>
                <p>&nbsp;&nbsp;44.1、签收人是受送达本人或者是前款指定的代收人的，签收人应当当场核对邮件内容。签收人发现邮件内容与回执上的文书名称不一致的，应当向邮政机构的投递员提出，否则视为一致。</p>
                <p>&nbsp;&nbsp;44.2、因受送达人自己提供或者确认的送达地址不准确、拒不提供送达地址、送达地址变更未及时告知人民法院、受送达本人或者指定的代收人拒绝签收，导致诉讼文书未能被受送达人实际接收的，文书退回之日视为送达之日。</p>
                <p>&nbsp;&nbsp;45、备注：</p>
				<p><input class="dtkz" name="remark" value="${aesc.remark}" /></p>
				<p>&nbsp;&nbsp;46、租金、合同保证金及物管费及水电空调费交款账号如下：</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;租金、合同保证金打款账号</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;名称：重庆汽博实业有限公司</p>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;开户银行：建行重庆两江汽博支行</p>
