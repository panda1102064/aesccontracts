...
<title>Insert title here</title>
	...
	<div class="PageNext"><jsp:include page="../../cover.jsp"/><!--动态包含--></div> 
		<div id="wrap">
				...
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<u> ${aesc.rental_location} </u>的承租人，承诺自愿接受甲方与重庆博展物业管理有限公司（以下简称“物业公司”）签订的《物业管理委托服务合同》之内容的约束，并按照该合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业， 则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。 </p>
