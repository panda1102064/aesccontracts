...
<title>Insert title here</title>
	...
	<div class="PageNext"><jsp:include page="../../cover.jsp"/><!--动态包含--></div> 
		<div id="wrap">
				...
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<u> ${aesc.rental_location} </u>的承租人，承诺自愿接受由甲方委托的重庆博展物业管理有限公司（以下简称“物业公司”）担任在汽博中心的物业服务企业，并按照该合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业， 则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。 </p>
				<br /><p class="zc">第二章 租赁物业概况</p><br />
				<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆两江新区金渝大道99号附15号（以下简称“汽博中心”）内的<u> ${aesc.lessee_location} </u>，其建筑面积为：<u> ${aesc.building_area} </u>㎡ 。该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
				...
				<c:forEach items="${requestScope.escList}" var="aescDate">
						<li><p><u> ${aescDate.year_str} </u>年<u> ${aescDate.month_str} </u>月<u> ${aescDate.day_str} </u>日至<u> ${aescDate.year_ed} </u>年<u> ${aescDate.month_ed} </u>月<u> ${aescDate.day_ed} </u>日，租金单价为：<u> ${aescDate.price} </u>元/㎡/月，每月租金合计为：<u> ${aescDate.total} </u>元，大写：<u> ${aescDate.upper2} </u>元整；优惠后实际月租金为：<u> ${aescDate.offer_rent} </u>元，大写：<u> ${aescDate.upper3} </u>元整。</p></li>
				</c:forEach>
				</ol>
				<p>&nbsp;&nbsp;7.2、房屋租金按<u> ${aesc.payment1} </u>支付。乙方应自本合同签订当日向甲方支付第一个<u> ${aesc.payment2} </u>的租金，以后乙方应在每<u> ${aesc.payment3} </u>初15日前支付当<u> ${aesc.payment4} </u>的租金。乙方逾期交纳租金，逾期在15内的，每逾期一日，应按未交纳租金的总额0.5％的标准向甲方支付滞纳金；逾期时间超过15日的，甲方有权单方解除合同，不予退还履约保证金，并可向乙方追收所欠租金及滞纳金。</p>
				<p>&nbsp;&nbsp;7.3、上述收费起算时间：从<u> ${aesc.charge_year1} </u>年<u> ${aesc.charge_month1} </u>月<u> ${aesc.charge_day1} </u>日起算。</p>
				<p>&nbsp;&nbsp;7.4、乙方应向甲方支付履约保证金：￥<u> ${aesc.cash_deposit} </u>元（大写）<u> ${aesc.upper1} </u>元整，在本合同签订时乙方应当立即以一次性付清的方式向甲方支付。合同有效期内若乙方擅自解除合同或有其它违反合同约定行为的，履约保证金和所剩租金不予退还，并纳入违约金范围之内。违约金不足以弥补损失的，甲方有权向乙方追讨，另行赔偿。合同到期后，如乙方无违约行为，履约保证金如数退还，但不计算利息。    </p>
				<p>&nbsp;&nbsp;7.5、前述租金及保证金的付款方式：现金或转帐。现金：乙方现金需缴纳至甲方财务部并开具发票式收据，甲方任何非财务人员不能现金收款；转账：乙方向甲方指定账户转账，非指定账户的转款不作为收款依据，乙方转账账户为乙方合同约定单位及公账，非合同约定单位或个人转账，需出具垫资证明。</p>
				<p>&nbsp;&nbsp;8、此合同到期后，甲方有权对该场地的租金价格保持一定幅度的递增。若乙方选择续签合同，原则上递增幅度将不超过10％。</p>
				<p>&nbsp;&nbsp;9、乙方应当向物业公司缴纳的物业费用：</p>
				<p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方租赁合同约定面积计收），汽博中心<u> ${aesc.area3} </u>的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<u> ${aesc.management_fee1} </u>元/㎡/月，物业管理服务费：<u> ${aesc.management_fee2} </u>元/月。</p>
				<p>&nbsp;&nbsp;9.2、商业用户水电交费单价分别为：电<u> ${aesc.power_rate} </u>元人民币/KW/小时，水<u> ${aesc.water_rate} </u>元人民币/T（含公共区域分摊费）。</p>
