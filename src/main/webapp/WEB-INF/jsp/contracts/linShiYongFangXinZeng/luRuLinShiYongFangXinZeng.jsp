...
<jsp:include page="../../headpart.jsp"></jsp:include>
		<div id="wrap">
			<form action="saveLsyf_xz" method="post">
				...
				<p>&nbsp;&nbsp;1、乙方作为入驻汽博中心<input required="required" class="dtkz" name="area1" value="临时用房" />的承租人，承诺自觉遵守物业管理区域的各项使用管理规定，维护汽博中心<input required="required" class="dtkz" name="area2" value="临时用房" />的整体品牌形象及商业信誉。</p>
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<input required="required" class="dtkz" name="area3" value="临时用房" />的承租人，承诺自愿接受由甲方委托的重庆博展物业管理有限公司（以下简称“物业公司”）担任在汽博中心的物业服务企业，并按照本合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业，则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。</p>
				<p class="zc">第二章     租赁物业概况</p>
        		<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆市北部新区经开园金渝大道99号（以下简称“汽博中心”）内的<input required="required" class="dtkz" name="rental_location" />，其建筑面积为：<input required="required" class="dtkzNum" name="building_area" /> ㎡ 。该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
		        ...
		        <p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<input required="required" class="dtkz" name="area4" value="临时用房" />的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<input required="required" class="dtkzNum" name="management_fee1" value="/"/>元/㎡/月，物业管理服务费：<input required="required" class="dtkzNum" name="management_fee2" value="/" />元/月。</p>
		        <p>&nbsp;&nbsp;9.2、中央空调使用耗能费：按实际公示标准收费。</p>
		        <p>&nbsp;&nbsp;9.3、商业用户水电交费单价分别为：电<input required="required" class="dtkzNum" name="power_rate" value="1.04" />元人民币/KW/小时，水<input required="required" class="dtkzNum" name="water_rate" value="4.80"/>元/T（含公共区域分摊费）。</p>
		        <p>&nbsp;&nbsp;9.4、公共区域的水电等公摊费用按据实分摊的原则收取。</p>
		        <p>&nbsp;&nbsp;9.5、前述物业费用按季度支付：在签定合同时，乙方应向甲方支付<input required="required" class="dtkz" name="payment4" value="第一个季度" />的物业费，以后乙方应在<input required="required" class="dtkz" name="payment5" value="每季度初15日前支付本季度" />的物业费。</p>
		        ...
		        <p>&nbsp;&nbsp;12、乙方租用甲方的房屋（场地）仅作为<input required="required" class="dtkz" name="purpose" value="" />展示使用。乙方不得超出约定范围经营；如需变更经营范围，须提前二十天以书面形式告知甲方，经甲方书面同意后方可变更。否则，甲方有权单方解除合同，且不退还乙方已缴纳的租金及履约保证金。</p>
		        ...
		        <p>&nbsp;&nbsp;21、乙方不得在租赁物内及室外存放易燃易爆等危险物品。</p>
		        ...
		        <p>&nbsp;&nbsp;43、备注：<textarea name="remark" rows="3" cols="150"></textarea></p>
