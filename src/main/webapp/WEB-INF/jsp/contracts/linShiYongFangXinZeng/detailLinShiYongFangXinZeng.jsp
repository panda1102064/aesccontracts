...
<body>
		<div id="wrap">
			<div class="PageNext"><jsp:include page="../../cover.jsp"/><!--动态包含--></div>
				...
				<p>&nbsp;&nbsp;2、乙方作为入驻汽博中心<u> ${aesc.area3} </u>的承租人，承诺自愿接受由甲方委托的重庆博展物业管理有限公司（以下简称“物业公司”）担任在汽博中心的物业服务企业，并按照本合同的约定向物业公司履行相关义务（包括但不限于以物业使用人的身份缴纳物管费、水电费等）。在租赁期间，若物业公司不再担任汽博中心的物业服务企业，则乙方应当向实际担任汽博中心的物业服务企业缴纳相关费用。</p>
				<p class="zc">第二章     租赁物业概况</p>
        		<p>&nbsp;&nbsp;3、租赁物业基本情况：</p>
				<p>&nbsp;&nbsp;3.1、乙方承租的甲方商业用房（场地），位于：重庆市北部新区经开园金渝大道99号（以下简称“汽博中心”）内的<u> ${aesc.rental_location} </u>，其建筑面积为：<u> ${aesc.building_area} </u>㎡ 。该租赁场地的房屋（场地）租金、物业管理服务费或其它根据场地面积计算的款项均以本款约定的租赁建筑面积计算。</p>
            	...
            	<ol>
				<c:forEach items="${requestScope.lsyfList}" var="aescDate">
						<li><p><u> ${aescDate.year_str} </u>年<u> ${aescDate.month_str} </u>月<u> ${aescDate.day_str} </u>日至<u> ${aescDate.year_ed} </u>年<u> ${aescDate.month_ed} </u>月<u> ${aescDate.day_ed} </u>日，每月租金合计为：<u> ${aescDate.price} </u>元，大写：<u> ${aescDate.upper} </u>元整。</p></li>
				</c:forEach>
				</ol>
		        <p>&nbsp;&nbsp;7.2、房屋租金按<u> ${aesc.payment1} </u>支付。在签定合同时，乙方应向甲方支付<u> ${aesc.payment2} </u>的租金，以后乙方应在<u> ${aesc.payment3} </u>的租金。乙方逾期交纳租金，逾期在15内的，每逾期一日，应按未交纳租金的总额0.5％的标准向甲方支付滞纳金；逾期时间超过15日的，甲方有权单方解除合同，不予退还履约保证金，并可向乙方追收所欠租金及滞纳金。</p>
		        ...
		        <p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<u> ${aesc.area4} </u>的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<u> ${aesc.management_fee1} </u>元/㎡/月，物业管理服务费：<u> ${aesc.management_fee2} </u>元/月。</p>
		        <p>&nbsp;&nbsp;9.2、中央空调使用耗能费：按实际公示标准收费。</p>
		        <p>&nbsp;&nbsp;9.3、商业用户水电交费单价分别为：电<u> ${aesc.power_rate} </u>元人民币/KW/小时，水<u> ${aesc.water_rate} </u>元/T（含公共区域分摊费）。</p>
		        <p>&nbsp;&nbsp;9.4、公共区域的水电等公摊费用按据实分摊的原则收取。</p>
		        <p>&nbsp;&nbsp;9.5、前述物业费用按季度支付：在签定合同时，乙方应向甲方支付<u> ${aesc.payment4} </u>的物业费，以后乙方应在<u> ${aesc.payment5} </u>的物业费。</p>
		        ...
		        <p>&nbsp;&nbsp;12、乙方租用甲方的房屋（场地）仅作为<u> ${aesc.purpose} </u>展示使用。乙方不得超出约定范围经营；如需变更经营范围，须提前二十天以书面形式告知甲方，经甲方书面同意后方可变更。否则，甲方有权单方解除合同，且不退还乙方已缴纳的租金及履约保证金。</p>
