...
<body>
		...
		<div class="PageNext"><jsp:include page="../../cover.jsp"/><!--动态包含--></div>
				...
				<p>&nbsp;&nbsp;9.1、物业管理服务费（按乙方承租的物业实际建筑面积计收），汽博中心<u> ${aesc.property} </u>的用房为商业性质的物业，物业管理服务费的收费标准经重庆市物局审批为：<u> ${aesc.management_fee1} </u>，物业管理服务费：<u> ${aesc.management_fee} </u>元/月。</p>
